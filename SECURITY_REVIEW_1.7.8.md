# Security review — ConTrackTor v1.7.8
...
- The one-time reviewed Grace correction uses a pre-migration SQLite backup, a guarded savepoint, exact-record checks, and an idempotent completion marker.
