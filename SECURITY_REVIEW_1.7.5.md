...
Candidate replacement: ConTracktor_v1_Update_1.7.5.exe
...
Local verification for v1.7.5: Microsoft Defender's on-demand scan of the completed installer on 21 September 2026 found no threats. The isolated installer test preserved the copied client database byte-for-byte, and the locked-database test correctly blocked installation. Prior v1.7.4 local scans were also clean, but none of these establish Microsoft cloud/download clearance for this build or another computer.
