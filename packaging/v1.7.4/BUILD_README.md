# Standard Inno Setup updater (v1.7.4)
...
This is a prerelease packaging-remediation candidate. The original reported Wacatac detection remains pending Microsoft review; local scans are not clearance. See SECURITY_REVIEW_1.7.4.md in the repository.
