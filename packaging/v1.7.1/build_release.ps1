...
$InstallerOutput = (Resolve-Path "release").Path + "\ConTracktor_v1_Update_1.7.1.exe"
...
"$hash  ConTracktor_v1_Update_1.7.1.exe" | Set-Content -LiteralPath "release\SHA256SUMS.txt" -Encoding ascii
