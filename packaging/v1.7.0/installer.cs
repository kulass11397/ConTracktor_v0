    ...
    private static void Main()
    {
        ...
        try
        {
            ...
            if (!unattendedTest && MessageBox.Show(
                ...
                "This update adds cross-project expense funding and repayments, shared weekly cash-advance deductions, split-project attendance, and payroll payment distribution. New PC/DP allocations require manually selected withdrawal references and contribution amounts. It also includes a guarded one-time repair of the 21 reviewed allocation links, including returned DP reuse and cancelled duplicate attempts. Financial amounts are unchanged.\n\n" +
            ...
            if (!unattendedTest)
            {
                ...
                MessageBox.Show(
                    ...
                    "Your existing records were retained. The guarded WD-reference repair is applied automatically when the application first opens.",
