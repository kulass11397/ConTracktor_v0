...
$output=Join-Path $PSScriptRoot 'release\ConTracktor_v1_Update_1.7.2.exe'
$hash=(Get-FileHash -LiteralPath $output -Algorithm SHA256).Hash.ToLowerInvariant()
"$hash  ConTracktor_v1_Update_1.7.2.exe" | Set-Content -LiteralPath 'release\SHA256SUMS.txt' -Encoding ascii
