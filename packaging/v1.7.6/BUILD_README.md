# Standard Inno Setup updater (v1.7.6)
...
This is a prerelease packaging-remediation candidate. The original reported Wacatac detection remains pending Microsoft review; local scans are not clearance. See SECURITY_REVIEW_1.7.6.md in the repository.
